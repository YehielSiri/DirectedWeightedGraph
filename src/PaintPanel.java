...
public class PaintPanel extends JPanel {
	Directed_Weighted_Graph_Algorithms dg;
	...
	public PaintPanel(String s) {
		super();
		this.l = new HashMap<>();
		this.dg = new Directed_Weighted_Graph_Algorithms();
		dg.load(s);
		initPoints();
	}
	...
	protected void paintComponent(Graphics g) {
		...
		HashMap<String,EdgeData> copy = new HashMap<>(((Directed_Weighted_Graph) (dg.getGraph())).getEdges());
		if (dEdges != null) {
