...
public class Json_Handler /*implements JsonHandler*/ {
	 ...
	 */
	public static boolean JsonSerializer(String json_file, Directed_Weighted_Graph graph) {
...
class G_S_Handler implements Serializable {
	...
	public G_S_Handler(DirectedWeightedGraph graph) {
		Iterator<NodeData> nodesPointer = graph.nodeIter();
		Iterator<EdgeData> edgesPointer = graph.edgeIter();
